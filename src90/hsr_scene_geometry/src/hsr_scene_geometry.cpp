...
int main(int argc, char* argv[])
{
  ...
  auto const node = std::make_shared<rclcpp::Node>(
      "add_walls", rclcpp::NodeOptions().automatically_declare_parameters_from_overrides(true));

  // Create a ROS logger
  auto const logger = rclcpp::get_logger("add_walls");
