...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("iiwa_trajectory_test");
...
public:
    ConstrainedPlanning(const rclcpp::Node::SharedPtr& node) : node_(node), marker_count_(0)
    {
        ...
        // move_group_->setVelocityScaling(0.1); THESE DO NOT WORK
        // move_group_->setAccelScaling(0.1);
    ...
    void moveToStart()
    {
        ...
        goal.orientation.x = 0.00;
        goal.orientation.y = 0.00;
...
int main(int argc, char** argv)
{
    ...
    rclcpp::Node::SharedPtr node = rclcpp::Node::make_shared("run_iiwa_trajectory_test", node_options);
