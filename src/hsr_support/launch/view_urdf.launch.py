...
def generate_launch_description():
    ...
    package_path = get_package_share_directory('hsr_support')
    ...
    # RViz
    rviz_config_file = get_package_share_directory('hsr_support') + "/launch/view_urdf.rviz"
    ...
    return LaunchDescription([robot_state_publisher, rviz_node, joint_state_publisher_gui]) #implant_handler